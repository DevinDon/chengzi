...
export const SwitchComponent = ({ title, value, setValue }: Props) => <Switch.Group>
  <StyledGroup>
    {title && <Switch.Label>{title}</Switch.Label>}
    <Switch
      checked={value}
      onChange={setValue}
      className={classNames(
        value ? 'bg-yellow-500' : 'bg-gray-200',
